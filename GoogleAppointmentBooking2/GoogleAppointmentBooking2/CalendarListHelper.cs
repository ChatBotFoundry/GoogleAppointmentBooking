   ...
   public class CalendarListHelper
    {
        ...
        public static void getEvents(CalendarService service, string calendarId, out List<DateTime> eventTimes)
        {
            ...
            if (events.Items != null && events.Items.Count > 0)
            {
                foreach (var eventItem in events.Items)
                {
                    ...
                    eventTimes.Add(eventItem.Start.DateTime.Value);
        ...
        public static void insertEvent(CalendarService service, string calendarId, string summary, string description, DateTime _startTime)
        {
            // Define parameters of request.
            //EventsResource.ListRequest request = service.Events.List(calendarId);
            ...
            myEvent.Location = "Telki, Hungary";

            EventDateTime startTime = new EventDateTime();
            startTime.DateTime = _startTime;
            myEvent.Start = startTime;

            EventDateTime endTime = new EventDateTime();
            endTime.DateTime = _startTime.AddMinutes(60);
            myEvent.End = endTime;

            myEvent.Visibility = "default";
            myEvent.Kind = "calendar#event";
